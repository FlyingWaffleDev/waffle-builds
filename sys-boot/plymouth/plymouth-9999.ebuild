...
PATCHES=(
	...
	"${FILESDIR}"/plymouth-quit.service.in.patch
	"${FILESDIR}"/plymouth-start.service.in.patch
)
...
src_install() {
	...
	doins "${FILESDIR}"/lightdm-plymouth.service
	doins "${FILESDIR}"/lxdm-plymouth.service
	doins "${FILESDIR}"/sddm-plymouth.service
	doins "${FILESDIR}"/slim-plymouth.service
	doins "${FILESDIR}"/plymouth-deactivate.service
	doins "${FILESDIR}"/plymouth-start.path
